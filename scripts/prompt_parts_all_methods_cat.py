...
# --- DATA ---
IMAGE_PATH = "/Users/emirhan/Desktop/LeGrad-1/cat_3.jpg"
OUTPUT_DIR = os.path.join(project_root, "outputs", "cat_parts_all_methods")

CONCEPTS = [
    "head", "ears", "eyes", "whiskers", "breast",
    "neck", "back", "belly", "legs", "paws", "tail", "fur"
]
...
VIS_CONCEPTS = [
    "head", "ears", "eyes", "back", "legs", "paws", "tail"
]
...
def main():
    ...
    for concept in CONCEPTS:
        prompt = f"a photo of a {concept} of a cat."
